    ...
    ui(new Ui::LoginSystem)
{
    ...
    QPixmap *pixmap = new QPixmap(":/Imgs/lake-7581726_1280.png");
    pixmap->scaled(ui->background->size(), Qt::KeepAspectRatio);
...
void LoginSystem::on_completeRegButton_clicked()
{
    ...
    else
    {
        ...
        if(regflag)
        {
            ...
            // ui->mBox->setText("");
            // ui->lBox->setText("");
            ui->rpLabel->setText("://Imgs/023-10-27 161236.png");
...
void LoginSystem::on_winStack_currentChanged(int arg1)
{
    ...
    if(arg1 == 2 && this->loggedIn)
    {
        ...
        while (fetcher.next())
        {
            name = fetcher.value(idusername).toString();
